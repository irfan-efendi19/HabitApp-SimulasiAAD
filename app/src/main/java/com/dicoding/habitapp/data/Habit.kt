...
data class Habit(
    ...
    @NonNull @ColumnInfo(name = "minutesFocus") val minutesFocus: Long,
    @NonNull @ColumnInfo(name = "startTime") val startTime: String,
    @NonNull @ColumnInfo(name = "priorityLevel") val priorityLevel: String
) : Parcelable